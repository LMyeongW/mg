                    ...
                    <div class="con">
                        ...
                        <div class="right">
                            <div class="title_input">
                                <input type="text" name="announcementTitle" placeholder="제목을 입력해주세요." value="${data.announcementTitle}">
                            </div>
                            <div class="category_select">
                                <select name="announcementCategory" id="announcementCategory">
                                    <option>${data.announcementCategory}</option>
                                    <option value="a1">공지사항</option>
                                    <option value="a2">이벤트</option>
                                </select>
                            </div>
                            <div class="content_text">
                                <textarea name="announcementContent" id="" class="text" placeholder="내용을 입력해주세요.">${data.announcementContent}</textarea>
                            </div>
                        </div>
                        <!-- .right -->
...
<script>
	$(document).ready(function(){
		...
		$('.cancel_btn').on("click", function(){
			var con = confirm("수정페이지에서 나가시겠습니까?");
